...
class PerVolumeWordStreamJSONFilelistFlatmap implements FlatMapFunction<String, String>
{
	...
	public PerVolumeWordStreamJSONFilelistFlatmap(String input_dir, int verbosity, 
